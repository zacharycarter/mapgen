...
public class PlanetMapGenerator  {
    ...
    public static final double SEA_LEVEL = CommonRNG.getRng().between(.5, 1);
    public static final double BEACH_LEVEL = CommonRNG.getRng().between(SEA_LEVEL, 1);
    public static final double PLAINS_LEVEL = CommonRNG.getRng().between(BEACH_LEVEL, 1);
    public static final double MOUNTAIN_LEVEL = CommonRNG.getRng().between(PLAINS_LEVEL, 1);
    public static final double SNOW_LEVEL = CommonRNG.getRng().between(MOUNTAIN_LEVEL, 1);
    public static final double DEEP_SEA_LEVEL = -0.1;
...
//        SColor.GREEN_BAMBOO, SColorFactory.lighter(SColor.LIGHT_BLUE_SILK), SColor.ALICE_BLUE, SColor.AZUL};
    ...
    private List<Coord> cities = new LinkedList<Coord>();
    ...
    public PlanetMapGenerator(int width, int height)
    {
        this(width, height, new StatefulRNG());
    }
    public PlanetMapGenerator(int width, int height, long rngSeed)
    {
        this(width, height, new StatefulRNG(rngSeed));
    }

    public PlanetMapGenerator(int width, int height, StatefulRNG rng)
    {
        this.rng = rng;
        this.width = width;
        this.height = height;
